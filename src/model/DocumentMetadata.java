...
public final class DocumentMetadata {
     ...
     */
    public DocumentMetadata(String path, boolean isModified) {
        this.filePath = path;
     ...
     */
    public DocumentMetadata withFilePath(String newPath) {
     ...
     * @effects returns new instance
     */
    public DocumentMetadata withModified(boolean isModified) {
